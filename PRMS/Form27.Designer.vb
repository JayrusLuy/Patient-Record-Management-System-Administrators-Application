...
Partial Class Form27
    ...
    Private Sub InitializeComponent()
        ...
        Label5.Location = New Point(471, 312)
        Label5.Name = "Label5"
        Label5.Size = New Size(206, 136)
        Label5.TabIndex = 36
        Label5.Text = "Desktop Application Programmer" & vbCrLf & vbCrLf & "Name: Jayrus T. Luy" & vbCrLf & "Mobile Number: 09157043239" & vbCrLf & "Facebook: Jayrus Luy" & vbCrLf & "Email: luyjayrus03@gmail.com" & vbCrLf & vbCrLf & vbCrLf
        ' 
        ' Label6
        ' 
        Label6.AutoSize = True
        Label6.Font = New Font("Century Gothic", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label6.Location = New Point(723, 283)
        Label6.Name = "Label6"
        Label6.Size = New Size(120, 19)
        Label6.TabIndex = 37
        Label6.Text = "Video Tutorials"
        ' 
        ' Label4
        ' 
        Label4.AutoSize = True
        Label4.Font = New Font("Century Gothic", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label4.Location = New Point(471, 83)
        Label4.Name = "Label4"
        Label4.Size = New Size(148, 19)
        Label4.TabIndex = 35
        Label4.Text = "Vision and Mission"
        ' 
        ' Label3
        ' 
        Label3.AutoSize = True
        Label3.Font = New Font("Century Gothic", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label3.Location = New Point(471, 283)
        Label3.Name = "Label3"
        Label3.Size = New Size(186, 19)
        Label3.TabIndex = 34
        Label3.Text = "Need Help? Contact Us"
        ' 
        ' Label2
        ' 
        ...
        PictureBox1.Size = New Size(1024, 78)
        ...
        Label8.Location = New Point(471, 605)
        Label8.Name = "Label8"
        Label8.Size = New Size(335, 17)
        Label8.TabIndex = 41
        Label8.Text = "© 2024 Jayrus Luy and Erin Tuzon BSIT Capstone 2 Project"
        ' 
        ' Form27
        ' 
